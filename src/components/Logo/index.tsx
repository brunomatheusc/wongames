...
export default function Logo({ color = 'white', size = 'normal', hideOnMobile = false }: LogoProps) {
    return (
        <S.Wrapper color={color} size={size} hideOnMobile={hideOnMobile}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 158 48" role="img" aria-label="Won games">
                <defs/>
                <path fill="url(#paint0_linear)" d="M.055 15.227L.019 35.872c-.008 4.796 5.336 7.663 9.327 5.004l20.596-13.722L50.49 40.947c3.982 2.672 9.335-.176 9.344-4.972l.034-19.997c.014-7.882-7.549-13.565-15.116-11.361l-.873.254a50.875 50.875 0 01-29.358-.27C7.351 2.366.068 7.716.055 15.226z"/>
                ...
                <defs>
                    <linearGradient id="paint0_linear" x1="29.159" x2="30.155" y1="-7.397" y2="49.103" gradientUnits="userSpaceOnUse">
