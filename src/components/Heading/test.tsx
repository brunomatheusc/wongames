...
describe('<Heading />', () => {
	...
	it('should render a heading with a line to the left side', () => {
		...
		expect(screen.getByRole('heading', { name: /Won Games/i})).toHaveStyle({ 'border-left': '0.7rem solid #F231A5'});
	});

	it('should render a heading with a line at the bottom side', () => {
		renderWithTheme(<Heading lineBottom>Won Games</Heading>);

		expect(screen.getByRole('heading', { name: /Won Games/i}))
			.toHaveStyleRule(
				'border-bottom',
				'0.5rem solid #F231A5',
				{ modifier: '::after' }
	...
	it('should render a heading with a small size', () => {
		...
		expect(screen.getByRole('heading', { name: /won games/i })).toHaveStyle({ 'font-size': '1.6rem' });
		expect(screen.getByRole('heading', { name: /Won Games/i}))
			.toHaveStyleRule(
				'width',
				'3rem',
	...
	it('should render a heading with a huge size', () => {
		...
		expect(screen.getByRole('heading', { name: /won games/i })).toHaveStyle({ 'font-size': '5.2rem' });
	});
