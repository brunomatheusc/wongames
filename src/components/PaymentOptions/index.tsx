	...
	return (
		<S.Wrapper>
            <S.Body>
				...
				<S.CardsList>
					...
					<S.CardItem key={card.number}>
						...
						<Radio name="credit-card" id={card.number} value={card.number} onCheck={() => setChecked(true)} role="radio" />
					</S.CardItem>
					))}
			...
			<S.Footer>
				...
				<Button fullWidth icon={<ShoppingCart />} onClick={handlePayment} disabled={!checked}>Buy now</Button>
			</S.Footer>
		</S.Wrapper>
	);
};