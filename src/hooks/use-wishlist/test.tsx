...
import { wishlistMock, wishlistItems, createWishlistMock, updateWishlistMock, removeWishlistMock } from './mock';
...
describe('useWishlist', () => {
	...
	it('should return check wether the game is in Wishlist', async () => {
		const wrapper = ({ children }: { children: React.ReactNode }) => (
			<MockedProvider mocks={[wishlistMock]}>
				<WishlistProvider>{ children }</WishlistProvider>
			</MockedProvider>
